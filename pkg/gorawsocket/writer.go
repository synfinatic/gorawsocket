...
type RawSocketSerializeOptions interface{}
...
type SerializeOptions struct {
	...
	// HostByteOrderLength specifies that the Layer 3/IP header length will be
	// serialized in host byte order to make it compatible with certain OS
	// RAW sockets
	HostByteOrderLength bool
}
...
func (w *serializeBuffer) Layers() []gopacket.LayerType {
	return w.layers
}

func (w *serializeBuffer) PushLayer(l gopacket.LayerType) {
...
func SerializePacket(buf SerializeBuffer, opts SerializeOptions, packet gopacket.Packet) error {
